...
public class PlaceShipPerson : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private bool IsShipPlacementValid(Vector3 shipPosition)
    {
        ...
        foreach (var placed in placedShips)
        {
            ...
            PlaceShipPerson placedShip = placed.GetComponent<PlaceShipPerson>();
    ...
    public static string ExportShipsAsGameJSON(int gameId = 1)
    {
        ...
        for (int i = 0; i < placedShips.Count; i++)
        {
            ...
            PlaceShipPerson placeShip = ship.GetComponent<PlaceShipPerson>();
    ...
    private static List<string> GetOccupiedCellNames(PlaceShipPerson ship)
    {
